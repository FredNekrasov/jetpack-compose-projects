...
internal val repositoryModule = module {
    ...
    }.withOptions { qualifier = qualifier(DMQualifiers.JD_REPOSITORY) }
    ...
    }.withOptions { qualifier = qualifier(DMQualifiers.MATH_REPOSITORY) }
    ...
    }.withOptions { qualifier = qualifier(DMQualifiers.ASTRONOMY_INFO_REPOSITORY) }
}