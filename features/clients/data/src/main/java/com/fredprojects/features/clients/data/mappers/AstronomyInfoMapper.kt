...
internal fun AstronomyInfoEntity.toDomain() = AstronomyInfo(
    dec, name, references, ra, radius
)
internal fun AstronomyInfoDto.toEntity(ra: String, name: String, dec: String, radius: Float) = AstronomyInfoEntity(
